...
生成时间：`2026-08-15T16:41:49+08:00`  
仓库：`E:\projects\简历投递助手`  
分支：`master`  
HEAD：`06dbb9f`  
未提交路径数：`80`
...
M .superpowers/sdd/task-2-report.md
 ...
 M apps/api/src/applications/application-machine.test.ts
 M apps/api/src/applications/application-progress.test.ts
 M apps/api/src/applications/application-progress.ts
 M apps/api/src/applications/application-service.ts
 M apps/api/src/applications/application-task-repository.test.ts
 M apps/api/src/applications/control-value.test.ts
 M apps/api/src/applications/control-value.ts
 M apps/api/src/applications/entry-field-semantics.test.ts
 M apps/api/src/applications/entry-field-semantics.ts
 M apps/api/src/applications/field-coverage.test.ts
 M apps/api/src/applications/field-coverage.ts
 M apps/api/src/applications/field-semantic-resolver.test.ts
 M apps/api/src/applications/field-semantic-resolver.ts
 M apps/api/src/applications/production-field-resolver.ts
 M apps/api/src/applications/repeated-section-planner.test.ts
 M apps/api/src/applications/repeated-section-planner.ts
 M apps/api/src/applications/routes.test.ts
 M apps/api/src/applications/routes.ts
 M apps/api/src/applications/task-events.test.ts
 M apps/api/src/production-dependencies.test.ts
 M apps/api/src/profile/profile-completeness.test.ts
 M apps/browser-worker/src/activity-monitor.test.ts
 M apps/browser-worker/src/activity-monitor.ts
 M apps/browser-worker/src/control-adapters.ts
 M apps/browser-worker/src/executor.test.ts
 M apps/browser-worker/src/executor.ts
 M apps/browser-worker/src/ipc-server.test.ts
 M apps/browser-worker/src/ipc-server.ts
 M apps/browser-worker/src/observer.test.ts
 M apps/browser-worker/src/observer.ts
 M apps/synthetic-ats/src/server.test.ts
 M apps/synthetic-ats/src/server.ts
 M apps/web/src/applications/ApplicationTaskPage.test.tsx
 M apps/web/src/applications/ApplicationTaskPage.tsx
 M apps/web/src/applications/FieldCoveragePanel.test.tsx
 M apps/web/src/applications/FieldCoveragePanel.tsx
 M apps/web/src/applications/ProgressSummary.test.tsx
 M apps/web/src/applications/TaskStageStepper.tsx
 M apps/web/src/applications/application-workbench.test.ts
 M apps/web/src/applications/application-workbench.ts
 M apps/web/src/applications/useTaskEvents.test.ts
 M apps/web/src/applications/useTaskEvents.ts
 M apps/web/src/profile/CandidateProfileCenter.test.tsx
 M apps/web/src/profile/CandidateProfileCenter.tsx
 M apps/web/src/profile/RepeatedEntryEditor.test.tsx
 M apps/web/src/profile/RepeatedEntryEditor.tsx
 M apps/web/src/router.test.tsx
 M apps/web/src/styles.css
 M packages/contracts/src/application.test.ts
 M packages/contracts/src/application.ts
 M packages/contracts/src/browser.test.ts
 M packages/contracts/src/browser.ts
 M packages/form-semantics/src/extraction-field-paths.test.ts
 M packages/form-semantics/src/field-registry.test.ts
 M packages/form-semantics/src/field-registry.ts
 M packages/form-semantics/src/mokahr-adapter.test.ts
 M packages/form-semantics/src/mokahr-adapter.ts
 M packages/form-semantics/src/normalize.test.ts
 M packages/form-semantics/src/normalize.ts
 M packages/form-semantics/src/snapshot-script.ts
 M packages/profile-domain/src/extraction/extract-facts.test.ts
 M packages/profile-domain/src/extraction/extract-facts.ts
 M packages/rag/src/rag-loop.test.ts
 M packages/rag/src/verifier.ts
 M tests/browser/application-workbench-visual.spec.ts
 M tests/browser/dji-coverage.spec.ts
 M tests/browser/mokahr-high-coverage.spec.ts
?? HANDOFF.md
?? apps/api/src/applications/experience-routing.test.ts
?? apps/api/src/applications/experience-routing.ts
?? apps/api/src/applications/field-operation-key.test.ts
?? apps/api/src/applications/field-operation-key.ts
?? apps/synthetic-ats/public/stability.html
?? create_handoff.py
?? docs/testing/
?? tests/browser/ats-autofill-stability.spec.ts
```
