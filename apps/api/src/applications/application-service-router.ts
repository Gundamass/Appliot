...
export function createApplicationServiceRouter(
  ...
  return {
    ...
    resumeAfterAdapterCertification(taskId) {
      return serviceFor(taskId).resumeAfterAdapterCertification(taskId);
    },
    ...
    adapterReview(taskId) {
      return serviceFor(taskId).adapterReview(taskId);
    },
